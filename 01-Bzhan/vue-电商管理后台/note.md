...
1. 下载 phpStudy2016 版本，启动 mysql，然后导入`vueShop-api-server-master/db`下的 mydb 文件，也就是还原，还原的库名也是叫 mydb
2. 成功后在 phpStudy 软件安装目录下的`MySQL/data`下有 mydb 的文件夹，下面就是各个数据表
