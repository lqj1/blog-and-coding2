<template>
  <div>
    ...
    <el-dialog title="修改地址" :visible.sync="addressVisible" width="50%" @close="addressDialogClosed">
      <el-form :model="addressForm" :rules="addressFormRules" ref="addressFormRef" label-width="100px">
        <el-form-item label="省市区/县" prop="address1">
          <!-- options用来指定数据源 -->
          <el-cascader v-model="addressForm.address1" :options="cityData" @change="addressChanged" clearable>
          </el-cascader>
        </el-form-item>
    ...
    <el-dialog title="物流进度" :visible.sync="progressVisible" width="50%">
      <el-timeline>
        <el-timeline-item v-for="(activity, index) in progressInfo" :key="index" :color="activity.color"
...
export default {
  data () {
    return {
      ...
      progressVisible: false, // 物流进度的对话框
      addressForm: {
        address1: [],
        address2: '',
      },
